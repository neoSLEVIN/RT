...
/*   Updated: 2020/05/21 03:32:57 by cschoen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ocl.h"

static void	set_memory_input_seeds(t_ocl *ocl)
{
	cl_int			err;
	int				i;
	unsigned int	*seeds;
