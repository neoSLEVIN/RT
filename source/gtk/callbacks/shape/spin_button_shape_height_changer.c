...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   spin_button_shape_height_changer.c                 :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: cschoen <cschoen@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/05 22:24:38 by cschoen           #+#    #+#             */
/*   Updated: 2020/09/05 22:24:39 by cschoen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "gtk_module.h"

static gboolean	spin_button_shape_height_changer_safe(gpointer data)
{
	t_rt	*rt;
	FLT3	*params;
