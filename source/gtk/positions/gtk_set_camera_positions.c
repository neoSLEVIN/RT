...
static void	gtk_set_camera_display_positions(t_gtk_camera *camera)
{
	...
	gtk_grid_attach_next_to(GTK_GRID(camera->display_grid),
		camera->display_width.change, camera->display_width.label,
		GTK_POS_RIGHT, (IS_APPLE ? 1 : 5), 1);
	gtk_grid_attach_next_to(GTK_GRID(camera->display_grid),
		camera->display_height.label, camera->display_width.label,
		GTK_POS_BOTTOM, 1, 1);
	gtk_grid_attach_next_to(GTK_GRID(camera->display_grid),
		camera->display_height.change, camera->display_height.label,
		GTK_POS_RIGHT, (IS_APPLE ? 1 : 5), 1);
	gtk_grid_attach_next_to(GTK_GRID(camera->display_grid),
		camera->fov.label, camera->display_height.label,
		GTK_POS_BOTTOM, 1, 1);
	gtk_grid_attach_next_to(GTK_GRID(camera->display_grid),
		camera->fov.change, camera->fov.label,
		GTK_POS_RIGHT, (IS_APPLE ? 1 : 5), 1);
	gtk_grid_attach_next_to(GTK_GRID(camera->display_grid),
		camera->fps.label, camera->fov.label,
		GTK_POS_BOTTOM, 1, 1);
	gtk_grid_attach_next_to(GTK_GRID(camera->display_grid),
		camera->fps.change, camera->fps.label,
		GTK_POS_RIGHT, (IS_APPLE ? 1 : 5), 1);
}
