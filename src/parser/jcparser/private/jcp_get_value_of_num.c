...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/05/03 02:35:03 by cschoen           #+#    #+#             */
/*   Updated: 2020/05/03 02:35:03 by cschoen          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "jcp_parser.h"

void	jcp_get_value_of_num(const char *json, size_t *i, t_jcp_object *obj)
{
