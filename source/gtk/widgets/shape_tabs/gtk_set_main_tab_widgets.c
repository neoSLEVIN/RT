											...
											DTO_SHAPE *dto)
{
	...
	gtk_set_spin_button_for_radius(&main_tab->radius.spin, dto->params[0].x);
	...
	gtk_set_spin_button_for_radius(&main_tab->width.spin, dto->params[0].x);
	...
	gtk_set_spin_button_for_radius(&main_tab->height.spin, dto->params[0].y);
