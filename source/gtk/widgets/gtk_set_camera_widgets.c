...
void	gtk_set_camera_widgets(t_gtk_camera *gtk_camera, CAMERA *cam)
{
	...
	gtk_set_changer(&gtk_camera->display_width, (INT2){MIN_WIDTH, COLS},
				cam->display.x, "Width:");
	gtk_set_changer(&gtk_camera->display_height, (INT2){MIN_HEIGHT, ROWS},
				cam->display.y, "Height:");
	gtk_set_changer(&gtk_camera->fov, (INT2){10, 160},
				cam->fov, "FOV:");
	gtk_set_changer(&gtk_camera->fps, (INT2){1, 80},
				cam->fps, "FPS:");
