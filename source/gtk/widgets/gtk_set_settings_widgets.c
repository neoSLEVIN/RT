...
void	gtk_set_settings_widgets(t_gtk_settings *settings, t_rt *rt)
{
	...
	gtk_set_changer(&settings->mirror, (INT2){1, 5},
		rt->scene->mirror, "Mirror:");
	settings->step = gtk_set_changer_float("Step:", (FLT2){0.01f, 1.0f},
		rt->scene->step, 0.01f);
	settings->angle = gtk_set_changer_float("Angle:", (FLT2){0.1f, 1.0f},
